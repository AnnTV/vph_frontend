...
export const sloganText =
    'В итоге вы приобретете не отвлеченные знания, а освоите мировые практики последних лет, необходимые для качественной и эффективной работы психологом.';
...
export const courseOptions = [
    ...
    { value: 'Экзистенциальный анализ базовый курс', label: 'Экзистенциальный анализ базовый курс', path: '/long_course/1#step_0', },
    { value: 'Экзистенциальный анализ клинический курс', label: 'Экзистенциальный анализ клинический курс', path: '/long_course/1#step_1', },
    { value: 'Экзистенциальный анализ супервизия', label: 'Экзистенциальный анализ супервизия', path: '/supervision#s_2', },
    { value: 'Экзистенциальный анализ интервизия', label: 'Экзистенциальный анализ интервизия', path: '/supervision#s_1', },
    { value: 'Психологическое консультирование базовый курс', label: 'Психологическое консультирование базовый курс', path: '/long_course/2#step_0', },
    { value: 'Психологическое консультирование супервизия', label: 'Психологическое консультирование супервизия', path: '/long_course/2#step_1', },
