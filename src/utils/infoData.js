...
export const sloganText =
    'Вы освоите мировые практики последних лет, необходимые для качественной и эффективной работы психологом.';
...
export const urlsLinks = [
    ...
    },
    {
        ...
        children: 'Краткосрочные курсы и программы',
    },
    {
        path: '/tacos',
...
export const cardsData = [
    ...
    {
        title: 'Узнаете последние тенденции',
        text:
...
export const accordionSpec = [
    {
        ...
        content: [
            'Летом 2021 года стартует психологическая группа по работе с ресурсным состоянием “Обновление. Поиск новых возможностей”.',
            'Идея группы возникла из убеждения, что внешние ограничения – возможность расширять свое присутствие во внутреннем мире.',
        ],
        steps: [
            {
                path: 'non_spec/0',
    ...
    },
    {
        ...
        content: [
            ...
            'В нашем институте «Высшей Психологической Школы» консультирование проводят психологи с 10-ти летним стажем (и даже более), решая быстро и эффективно множество различных запросов клиентов и проработкой сложных жизненных ситуаций. ',
        ],
        steps: [
            {
                path: 'non_spec/1',
    ...
    },
    {
        ...
        content: [
            'Группа самопознания «Практика хорошей жизни»',
            'Приглашаем присоединиться к долгосрочной группе самопознания. Старт группы - осень 2021г. Программа рассчитана на 8 месяцев. Количество участников – 8-10 человек.',
        ],
        steps: [
            {
                path: 'non_spec/2',
...
export const TYPE_LONG = 0;
export const TYPE_SHORT = 1;
export const TYPE_NON_SPEC = 3;
...
export const shortCourses = [
    ...
    {
        id: '4',
        title: 'Специализация по работе с бесплодием',
    },
    {
        id: '5',
        title: 'Тренинг «ДЕНЬГИ. ДЕНЕЖКИ. ДЕНЬЖИЩИ…»',
    },
];
...
export const courseOptions = [
    ...
    },
    {
        id: '0',
        type: TYPE_SHORT,
        value: 'Зависимость и созависимость',
        label: 'Зависимость и созависимость',
        pay: true,
    },
    {
        id: '1',
    ...
    },
    {
        id: '3',
        type: TYPE_SHORT,
        value: 'Хорошие контракты: участие',
        label: 'Хорошие контракты: участие',
        pay: true,
    },
    {
        id: '3',
        type: TYPE_SHORT,
        value: 'Хорошие контракты: дополнительная опция',
        label: 'Хорошие контракты',
        pay: true,
    },
    {
        id: '4',
        type: TYPE_SHORT,
        value: 'Специализация по работе с бесплодием',
        label: 'Специализация по работе с бесплодием',
    },
    {
        id: '5',
        type: TYPE_SHORT,
        value: 'Психотерапевтический тренинг «ДЕНЬГИ. ДЕНЕЖКИ. ДЕНЬЖИЩИ…»',
        label: 'Психотерапевтический тренинг «ДЕНЬГИ. ДЕНЕЖКИ. ДЕНЬЖИЩИ…»',
    },
    {
        id: '0',
        type: TYPE_NON_SPEC,
        value: 'Терапевтические группы',
        label: 'Терапевтические группы',
    },
    {
        id: '1',
        type: TYPE_NON_SPEC,
    ...
    },
    {
        id: '2',
        type: TYPE_NON_SPEC,
        value: 'Группа самопознания',
        label: 'Группа самопознания',
    },
...
export const payFormOptions = [
    ...
    },
    {
        ...
        amount: '3500',
        desc:
            'Вебинар ориентирован на психологов, уже начавших практику и желающих получить навыки\n' +
    ...
    },
    {
        ...
        desc:
            ...
            'формате малой группы. В течение 3-х доп.часов участники\n' +
            'предоставляют свои случаи и вопросы, ведущая прокомментирует кейсы и даст\n' +
