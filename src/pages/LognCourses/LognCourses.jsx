                ...
                <>
                    ...
                    <div className={'Page__block LongCourse__block-info'}>
                        <div className={'LongCourse__block-info__course'}>
                            ...
                            Я прошла обучение у Светланы Мардоян по базовому курсу ЭА, и там была такая ласковая, примающая и спосотсвующая твоему личностному и профессиональному опыту атмосфера, особенно по контрасту с университетом, ..., что захотелось и клинический курс пройти именно с ней, и вот ещё почему:
                            Светлана не просто глубоко и детально знает ЭА метод, этим владеют многие из первого набора Альфрида Лэнгле, она - долго и много практикующий психотерапевт, и поэтому любая сухая или сложная теоретическая выкладка, всегда может быть переведена ею в практическое русло и тогда, порой сложный, для начинающих психологов, теоретический материал , становится ясным, понятным и легко применимым на практике.
                            А ещё, Светлана очень поддерживающий супервизор и поэтому супервизироваться у неё не страшно, а полезно, т.к она всегда подскажет  верный путь из трудной профессиональной ситуации! Светлана всегда способствует практике своих начинающих студентов, знаю это из своего опыта и опыта своих сокурсников», а ещё, она «подбрасывает» клиентов, а ведь это очень важно, если ты начинающий психолог и своей клиентской базой пока не обзавёлся
                                <span className={'author'}>Лилия</span>
                            </p>

                            <p className={'LongCourse__block-info__reply'} >
                            Я проходила обучение  экзистенциальному анализу и логотерапии в группе Светланы Мрдоян. Это время оказало большое влияние на мое профессиональное становление, личностное развитие и жизнь в целом. Обучение состоит из  теоретических знаний и часов самопознания,как группового,так и индивидуального,которые помогают глубоко изучать материал,исследуя экзистенициальные темы через свой опыт и актуальную жизнь. В таком подходе очень важен человек,который сопровождает тебя на этом долгосрочно м пути. Светлана внимательный и чуткий тренер,прекрасный преподаватель,доносящий суть материала доступным языком, бережный психотерапевт. Экзистенициальные анализ невозможно воспринимать только как метод  работы психолога, для меня он стал ориентиром в том,как я проживаю свою жизнь каждый день, помогая прийти к исполненности.
                            Отзыв о супервизиях:
                            В рамках обучения ЭА(и не только) существует возможность проходить супервизии. Светлана имеет многолетний опыт работы психотерапевтом и супервизором. Разбор каждого кейса строится на феноменологическом восприятии проблемы/страдании клиента. Такой взгляд помогает очень точно выстроить работу с человеком. Участие в супервизиях является поддерживающим ресурсом,особенно для начинающих консультантов/психотерапевтов. В  ходе профессионального общения для меня всегда происходит обогащение знаний и умений, обнаружение тонкостей и нюансов,касающихся конкретных тем или построения терапевтических отношений.
                                <span className={'author'}>Нина</span>
                            </p>

                            <p className={'LongCourse__block-info__reply'} >
                            Я проходила обучение у Светы и базового, и клинического курсов, чем осталась очень довольна. Она даёт информацию четко и структурированно, подкрепляя попутно материал клиническими виньетками. Это позволяет понимать текст намного глубже и вдумчивей.
                            Супервизии у Светы это всегда прекрасная возможность поработать со случаем. Во-первых, сам факт презентации случая требует тщательной подготовки, в процессе которой зачастую многое проясняется. Во-вторых, способность Светы организовать процесс и задавать точные емкие вопросы крайне помогают, и, конечно, клинический опыт Светы очень ценен для понимания случая.
                        ...
                        <div className={'LongCourse__block-info__course'}>
                            ...
                            <ol>
                                <li>
                                    ...
                                    консультанта от своей работы и предполагаемых результатов
                                </li>
