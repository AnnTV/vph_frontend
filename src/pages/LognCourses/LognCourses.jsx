    ...
    switch (props.id) {
        ...
        case '1':
            return (
                <>
                    <BlockTitle
                        children={'Экзистенциальный анализ'}
                        className={'Page__block'}
                    />
                    ...
                    <div className={'Page__block LongCourse__block-info'}>
                        <div className={'LongCourse__block-info__course'}>
                            ...
                            <p>
                                Этими вопросами занималась экзистенциальная философия и психология. Экзистенциальный анализ и логотерапия – направление психотерапии, предложившее комплексный метод психологической работы на основе этих идей.
                                </p><p>
                                Международное общество экзистенциального анализа и логотерапии (GLE-International) ведет деятельность в странах ЕС, Швейцарии, Израиле, Великобритании, России, Аргентине и Канаде в области психологии, психотерапии, медицины, педагогики, психологии образования, менеджмента, переговоров и медиации.
                            </p>
                            ...
                            <p>
                                Программа предназначена для людей с высшим психологическим образованием, студентов старших курсов, обучающихся по направлению "Психология", а также представителям смежных специальностей (педагогика, медицина и др.).
                            </p>
                            <p>
                                По итогам обучения выдаётся диплом о переподготовке государственного образца по специальности "Психолог-консультант в экзистенциально-аналитическом направлении", а также международный сертификат GLE International (при выполнении всех требований).
                            </p>
                            ...
                            <ul>
                                ...
                                <li>экзистенциально-аналитическая диагностика и особенности консультирования при различной психопатологии.</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>самопознание в группе: освоение основных экзистенциальных тем, с которыми работает экзистенциальный анализ через персональный опыт участников;</li>
                                <li>практика при супервизорском сопровождении: анализ практических случаев участников образовательного проекта.</li>
                            </ul>
                        ...
                        <div className={'LongCourse__block-info__author'}>
                            ...
                            <p>Окончила Ереванский медицинский институт, ординатуру по психотерапии в РМАПО. Психотерапевт, экзистенциальный аналитик (диплом психотерапевта GLE-International).</p>
                            <p>Член совета тренеров Ассоциации экзистенциально-аналитических психологов и психотерапевтов, тренер, супервизор долгосрочной образовательной программы по экзистенциальному анализу и логотерапии GLE-International.</p>
                            ...
                            <p>Окончила МГППУ, факультет Психологическое консультирование и психотерапия, РГМУ, факультет клинической психологии, кандидат психологических наук. Экзистенциальный аналитик (диплом психотерапевта GLE-international), психофизиолог, коуч. Опыт психологического консультирования с 1996 года.</p>
                            ...
                            <p>Окончила МГУ им. М.В. Ломоносова, факультет психологии, кафедра психологии личности; РГМУ факультет клинической психологии; аспирантура ИП РАН.</p>
                            <p>Экзистенциальный аналитик (диплом психотерапвета GLE-international), Член совета тренеров Ассоциации экзистенциально-аналитических психологов и психотерапевтов. Опыт психологического консультирования более 10 лет, ведущая групп самопознания, автор практических семинаров и курсов по психологии.</p>

                            <span className={'LongCourse__block-info__name'}>Лэнгле Альфрид Антон</span>
                            <Devider width={240} />

                            <p>Ph.D., M.D., Dr. h.c., профессор, почетный президент Международного общества экзистенциального анализа и логотерапии (GLE-International), автор экзистенциально-аналитического подхода.</p>
        ...
        case '2':
            return (
                <>
                    <BlockTitle
                        children={'Психологическое консультирование'}
                        className={'Page__block'}
                        id={'step_0'}
                    />
                    ...
                    <div className={'Page__block LongCourse__block-info'}>
                        <div className={'LongCourse__block-info__course'}>
                            ...
                            <p>
                                Мы предлагаем панорамный взгляд на курс практической психологии: только актуальные знания, практические навыки работы с любым запросом, проработка личных содержаний – всё в одной программе.
                                Такой подход помогает слушателю приобрести опыт, для которого потребовалось бы несколько лет самостоятельных усилий.
                            </p>
                            <p>
                                Выпускникам академических вузов бывает трудно начать работу с клиентами. В течение нескольких лет они проходят курсы повышения квалификации, супервизии, чтобы выстроить понятную образовательную программу и найти себя как профессионал. Наша программа создана, чтобы сократить этот путь.
                            </p>

                            <span className={'LongCourse__block-info__title'}>Для кого</span>

                            <ul>
                                <li>Для всех желающих связать свою профессиональную деятельность с психотерапией и психологическим консультированием, особенно для выпускников академических вузов;</li>
                                <li>Для тех, кто выбирают психологию «для себя», чтобы обрести гармонию  с собой, партнером, членами семьи, в коммерческой организации;</li>
                                <li>Для начинающих специалистов, которые хотят познакомиться с профессией и заложить основу будущей карьеры;</li>
                                <li>Для действующих консультантов, которые хотят развивать карьеру, систематизировать и получить новые знания и навыки;</li>
                                <li>Для специалистов смежных направлений (врачам, логопедам, физическим терапевтам, педагогам, социальным педагогам, бизнес-тренерам, коучам и др.). </li>
                            </ul>

                            <p>К обучению допускаются студенты выпускного курса психологических факультетов. По окончании программы студенты могут продолжить углубленное обучение на других программах: Гештальт 1 и 2 ступени, Экзистенциальный анализ и других.
                            </p>

                            <span className={'LongCourse__block-info__title'}>Содержание</span>
                            <p>
                                Программа сфокусирована на формировании системных и фундаментальных практических знаний в профессии психолога-консультанта. Подробно разбирается каждый этап психологической работы. Значительное время уделено развитию практических навыков специалиста.
                            </p>
                            <p>Программа сгруппирована по 24 модулям — двухдневным и однодневным по 8 часов в день. Модули образуют тематические блоки. Обучение проходит по выходным. Программа откалибрована, чтобы при обучении три выходных в месяц были свободными.</p>

                            <span className={'LongCourse__block-info__title'}>Блок 1. Введение в психологическое консультирование</span>
                            <ol>
                            ...
                            <span className={'LongCourse__block-info__title'}>Блок 2. Работа с чувствами, телесными ощущениями, мыслями консультанта и клиента. Обработка внутренних содержаний</span>
                            <ol>
                                <li>Обработка базовых запросов: чувства вины, стыда, агрессии, страхов, тревоги, радости, счастья (способности испытывать и проживать), отвращения, обиды, грусти, печали
                                </li>
                                <li>Работа с чувствами в отношениях: абьюз, травма, зависимость и созависимость</li>
                                <li>Работа с телесными состояниями: телесными ощущениями и через образы (гештальт-подход)</li>
                                <li>Работа с когнитивными искажениями</li>
                                <li>Работа с установками</li>
                            </ol>

                            <span className={'LongCourse__block-info__title'}>Блок 3. Структура психологической работы</span>
                            <ol>
                            ...
                            <span className={'LongCourse__block-info__title'}>Блок 4. Профессиональная позиция психолога-консультанта</span>
                            <ol>
                                <li>Следование этическим принципам психологического консультирования
                                    Ожидания консультанта от своей работы и предполагаемых результатах</li>
                                <li>Работа с внутренними конфликтами</li>
                                <li>Работа с ресурсами консультанта</li>
                                <li>Сохранение баланса сил, поиск ресурсов и обработка разочарования в профессии или в своих навыках </li>
                                ...
                                <li>Восприятие критики (клиенты, коллеги, супервизор, собственный терапевт, окружение)</li>
                                <li>Формирование профессиональных отношений. Начало, заключение контракта, формирование стабильных долгосрочных отношений, завершение отношений консультант-клиент</li>
                                <li>Стабильная мотивация консультанта</li>
                                <li>Работа над профессиональными трудностями в формате обучения, супервизии</li>
                                <li>Формирование постобучающей линии развития (супервизорские и интервизорские группы, поддержание навыков, дополнительное обучение)</li>
                                <li>Перспективы дальнейшего обучения и развития</li>
                            </ol>

                            <span className={'LongCourse__block-info__title'}>Блок 5. Техники психологического консультирования в разных подходах</span>
                            <ol>
                        ...
                        <div className={'LongCourse__block-info__author'}>
                            ...
                            <p>Для разработки программы мы привлекли специалистов, постоянно занятых в сфере консультирования не менее 10 лет.</p>
                            <p>Модуль сгруппирован под каждого преподавателя исходя из его опыта. Формат обучения спроектирован, чтобы преподаватели делились своими передовыми знаниями и навыками. Полный список преподавателей на данный момент уточняется.</p>
